...
<rss version="2.0"><?cs
 ...
 def:rss_item(category,title, link, descr) ?>
  <item><?cs
   if:$item.author.rss ?>
    <author><?cs var:$item.author.rss ?></author><?cs
   /if ?>
