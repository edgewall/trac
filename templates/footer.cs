...
if:len(links.alternate) ?>
<div id="altlinks"><h3>Download in other formats:</h3><ul><?cs
 each:link = links.alternate ?><?cs
  set:isfirst = name(link) == 0 ?><?cs
  set:islast = name(link) == len(links.alternate) - 1?><li<?cs
...
<div id="footer">
 ...
 <a id="tracpowered" href="http://trac.edgewall.com/"><img src="<?cs
     var:htdocs_location ?>trac_logo_mini.png" height="30" width="107" alt="Trac Powered"/></a>
 <p class="left">
