...
from trac import diff2

class DiffTestCase(unittest.TestCase):

    def test_get_change_extent(self):
        self.assertEqual((3, 0), diff2._get_change_extent('xxx', 'xxx'))
        self.assertEqual((0, 0), diff2._get_change_extent('', 'xxx'))
        self.assertEqual((0, 0), diff2._get_change_extent('xxx', ''))
        self.assertEqual((0, 0), diff2._get_change_extent('xxx', 'yyy'))
        self.assertEqual((1, -1), diff2._get_change_extent('xxx', 'xyx'))
        self.assertEqual((1, -1), diff2._get_change_extent('xxx', 'xyyyx'))
        self.assertEqual((1, 0), diff2._get_change_extent('xy', 'xzz'))
        self.assertEqual((1, -1), diff2._get_change_extent('xyx', 'xzzx'))
        self.assertEqual((1, -1), diff2._get_change_extent('xzzx', 'xyx'))
